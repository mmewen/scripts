...
Thanks to [akras14](https://gist.github.com/akras14/3d242d80af8388ebca60)
...
# To undo a commit (leaves working tree as it was before "reset")
git reset --soft HEAD^
# then edit files and redo the commit
git commit -a -c ORIG_HEAD
```
The last commands come from [git-scm.com](https://git-scm.com/docs/git-reset#git-reset-Undoacommitandredo)
